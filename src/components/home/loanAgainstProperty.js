...
class LoanAgainstProperty extends Component {
    constructor() {
        super();
    ...
    render() {
        ...
        return (
            ...
            <div>
                <Header  active={2}/>
                <section className="banner-car-loan-section ">
                    ...
                    <div className="container p-0">
                        ...
                        <div class="col-xl-6 col-sm-6 col-lg-6 content">
                            ...
                            <h3 className="mb-0">Loan Against Property,</h3>

                            <p>happy miles, cheerful smiles.</p>
                        </div>
                        <div className="col-xl-6 col-sm-6 col-lg-6">
                        {/* <FloatingForm /> */}
                        <div className='floating-form-section-loan'>
									<LoanTypeForm text='testing but in small cases' loanType='Loan Against Property'></LoanTypeForm>
								</div>
                        </div>
                        </div>
                        </div>
                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                            ...
                                            A car loan is a borrowing instrument that a lender such as a bank or NBFC (non-banking financial company) provides an individual allowing him/her to purchase a car. With the increased popularity of car loans, most banks and NBFCs currently offer this type of loan to individuals who have a good credit history.
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingTwo">
                                            <h4 class="panel-title">
                                                ...
                                                What are the benefits of applying for a car loan with SMAPL?
                                        ...
                                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                            ...
                                            When you input your basic details into the SMAPL car loan eligibility tool, we provide you with all available options based on the information you provide us. After you get the complete list of lenders who might suit your specific requirement you can compare the various loan options based on tenure, interest rate, maximum loan amount as well as other factors.
SMAPL streamlines the loan selection process, allowing you to derive the maximum benefits from your car loan.
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingFour">
                                            <h4 class="panel-title">
                                                ...
                                                What is the typical tenure of Car Loan?
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingSeven">
                                            <h4 class="panel-title">
                                                ...
                                                Can I sell my vehicles before I repay the entire Loan?
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
                                            <div class="panel-body">
                                            Before we process a foreclosure, all outstanding dues must be cleared. So we request you to first check for and clear any remaining amount that may be payable towards your Car Loan by requesting a foreclosure statement from your nearest Bank.
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapseTen" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTen">
                                            <div class="panel-body">
                                            The amount of EMI (equated monthly instalments) that you will be paying towards your car loan will depend on the interest rate, loan amount, and the repayment tenure you choose. You can calculate the EMI. For example, let us suppose that you avail a car loan of Rs.1 lakh at an interest rate of 12% for a tenure of 5 years, calculated the EMI and found it to be Rs.2,224.
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapseEleven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEleven">
                                            <div class="panel-body">
                                            If your credit score is above 750, can negotiate with the banks to offer you a car loan at a lower interest rate. Many lenders will let you negotiate on the interest rates since your high credit score is an indication of your high repayment capacity. Some lenders may also offer you a waiver on the processing fee if you have a good credit score.
