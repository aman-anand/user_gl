...
import HomeIllustration from "../../images/home-loan-icon.svg";
import BusinessLoanIcon from "../../images/business-loan-icon.svg";
import personalLoanIcon from "../../images/personal-loan-icon.svg";
import LAPLoanIcon from "../../images/LAP-loan.svg";
import pathCover from "../../images/Path.svg";
...
class faq extends Component {
    ...
    render() {
        return (
            <div>                
                ...
                <div className='belowHeaderSection'>
						<div className='radiusPart'>
							<div className="d-flex justify-content-center extraNavPart text-20-bold">We are here for any assistance you need</div>
							<div className='d-flex justify-content-center curve'><img src={Rectangle}   /></div>
						</div>

						

						<div className='row loanTypeFaq'>
	...
	{this.state.loanType ==='Home Loan' &&
		...
		{this.state.pagination==3 &&
								...
								<div className='col-xl-5 text-center'>
									<div className='pathCoverImg'><img src={pathCover} width='382px' height='384px' alt='home-illustraion' /></div>
	...
	{/* Accordion Home Loan End */}
	 ...
	 {this.state.loanType ==='Personal Loan' &&
		...
		{this.state.pagination==3 &&
								...
								<div className='col-xl-5 text-center'>
								<div className='pathCoverImg'><img src={pathCover} width='382px' height='384px' alt='home-illustraion' /></div>
									<img src={personalLoanIcon} width='202px' height='284px' className='img-fluid' alt='home-illustraion' />
								</div>
							</div>
	...
	{/* Accordion Personal Loan End */}
	 ...
	 {/* Accordion Loan Against Property Start */}
	 {this.state.loanType ==='Loan Against Property' &&
								<div className='heading-faq container'>
									<div className='row  align-items-center justify-content-center'>
		...
		{this.state.pagination==1 &&
											...
											<div class="col-lg-12">
												<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
													...
													<div class="panel panel-default accordionTitle">
														...
														<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
															<div class="panel-body text-14-semibold grey dot">
																	<div>The loan amount depends on your repayment capability and is restricted to a maximum of
																		75% of the total market value as applicable. Repayment capacity takes into consideration
																		factors such as income, age, qualification, number of dependants, spouses income, assets,
																		liabilities, stability, continuity of occupation and savings history. And, of course, our main
																		concern is to make sure that you can comfortably repay the loan amount.</div>
													...
													<div class="panel panel-default accordionTitle">
														...
														<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
															<div class="panel-body text-14-semibold grey dot">
																<div>You have the option of selecting a term you are comfortable with, ranging from 5 to 30
																	years, provided the term does not extend beyond your reaching 65 years of age or
																	retirement age, whichever is earlier.</div>
													...
													<div class="panel panel-default accordionTitle">
														...
														<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
															<div class="panel-body text-14-semibold grey dot">
																<div>You can include your spouse as a co-applicant for the loan and we shall include his / her
																	income to enhance your home loan amount. Further, in case there are any other co-owners
																	they also need to be co-applicants. Other than the spouse, please check with your home
																	loan counsellor on the approved co-applicants for the loan.</div>
																{/* <div>If you apply online by filling in a brief form, you will get an in-principle approval on your query because we have partnered with several banks. This ensures faster turnaround time for your requirement.</div>
																<div>Our unique matchmaking algorithm ensures we match your requirement with the available options and share the result.</div>
																<div>One of our experts will contact you to provide information about available options and process your application. We will also arrange to get your documents and other paperwork picked up from you. </div>
																<div>If speaking to someone makes it's easier for you, you can reach us at sakalmoney.com . One of our experts will contact you to provide information about available options and process your application.</div> */}
													...
													<div class="panel panel-default accordionTitle">
														<div class="panel-heading" role="tab" id="headingFour">
															<h4 class="panel-title text-16-semibold blackish">
																<div class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
																4. What are the stages involved in taking a loan?
														...
														<div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
															<div class="panel-body text-14-semibold grey dot">
																	<div>There are three main stages:
																		<ul>
																			<li>Application - Whereby you submit a completely filled in application with all necessary documents.</li>
																			<li>Sanction - Whereby you get an approval for a specific loan amount based on the value of your property and repayment capabilities.</li>
																			<li>Disbursement - Whereby the loan amount is disbursed.</li>
																		</ul>
																	</div>
																	{/* <li>Between the age of 18/21 years - 60/65 years </li>
																	<li>Must be salaried or self-employed</li>
													...
													<div class="panel panel-default accordionTitle">
														...
														<div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
															<div class="panel-body text-14-semibold grey dot">
																<div>Your loan will be disbursed on:
																	<ul>
																		<li>Your identification and selection of the property</li>
																		<li>Submission of the legal documents</li>
																		<li>Legal and technical clearance of the property</li>
																		<li>Investment of your contribution towards the property</li>
																	</ul>
																</div>
																	{/* <li>Yes, you can apply for a loan with a co-applicant. All you have to do is specify it in the application form. Having a co-applicant increases your chances of availing an increased loan amount. This depends on the co-applicant's profile, income and obligations.</li> */}
													...
													<div class="panel panel-default accordionTitle">
														...
														<div id="collapse6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading6">
															<div class="panel-body text-14-semibold grey dot">
																	...
																	<div>In the case of a bounced or delayed payment, charges and outstanding dues will be charged as per the prevailing company policy.</div>
								...
								<div className='col-xl-5 text-center'>
								<div className='pathCoverImg'><img src={pathCover} width='382px' height='384px' alt='home-illustraion' /></div>
									<img src={LAPLoanIcon} width='252px' height='284px' className='img-fluid' alt='home-illustraion' />
								</div>
								</div>
							</div>
						}

	{/* Accordion Loan Against Property End */}
	 ...
	 {this.state.loanType ==='Business Loan' &&
		...
		{this.state.pagination==1 &&
								...
								<div className='col-xl-5 text-center'>
								<div className='pathCoverImg'><img src={pathCover} width='382px' height='384px' alt='home-illustraion' /></div>
									<img src={BusinessLoanIcon} width='182px' height='284px' className='img-fluid' alt='home-illustraion' />
								</div>
							</div>
						...
						<div className='col-lg-12 '>
							{/* <nav aria-label="..."> */}
								<ul class="pagination pagination-sm  text-14-semibold d-flex align-items-center">
									...
									<li class="page-item "><a onClick={this.pagination} class={this.state.pagination==1 ? "page-link activee" : "page-link"} href="#">1</a></li>
